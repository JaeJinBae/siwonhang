	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="btn-group">
			<div class="inner">
				<ul>
					<li class="fl">
						<a href="${pageContext.request.contextPath}/m/menu07_06" class="btn btn-view-list">목록으로</a>
					</li>
					<li class="fr">
						<a href="${pageContext.request.contextPath}/m/menu07_06delete${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}" class="btn btn-del">삭제</a>&nbsp;
						<a href="${pageContext.request.contextPath}/m/menu07_06update${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}" class="btn btn-update">수정</a>&nbsp;
					</li>
				</ul>		
			</div>
		</div>
