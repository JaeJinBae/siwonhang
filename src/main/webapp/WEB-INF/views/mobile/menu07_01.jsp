		...
		<div class="board-notice-list">
			<ul class="full">
				<li>
					<a href="">
						<b>  시원항병원 5월 휴진 안내</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2019-05-03</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  시원항병원에 1월부터 새로운 의료진이 함께합니다.</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2019-01-15</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  시원항병원 홈페이지를 오픈하였습니다.</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2018-08-17</i>
					</a>	
				</li>
			</ul>
		</div>
