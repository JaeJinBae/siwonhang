...
<!-- ********************************************플러그인********************************************* -->
<script src="http://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP2T42497517824&amp;py=0&amp;gd=dgc5&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1572581967185"></script>
		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							...
							<li class=""><a href="${pageContext.request.contextPath}/menu01_02">차별성</a></li>
							<li class="active"><a href="${pageContext.request.contextPath}/menu01_03">층별안내</a></li>
				...
				<div class="sub-contents">
					<h4 class="tit">층별안내</h4><!-- 서브 콘텐츠 타이틀 -->
					<input type="hidden" id="floor" name="floor" value="${floor}">
					<div class="floor-slider">
						<ul class="floor-info">
							<li id="f10">
								<a href="${pageContext.request.contextPath}/menu01_03?floor=f10">
									<b>10F</b>
								</a>
							</li>
							<li id="f9">
								<a href="${pageContext.request.contextPath}/menu01_03?floor=f9">
									<b>9F</b>
								</a>
							</li>
							<li id="f8">
								<a href="${pageContext.request.contextPath}/menu01_03?floor=f8">
									<b>8F</b>
								</a>
							</li>
							<li id="f7">
								<a href="${pageContext.request.contextPath}/menu01_03?floor=f7">
									<b>7F</b>
								</a>
							</li>
							<li id="f6">
								<a href="${pageContext.request.contextPath}/menu01_03?floor=f6">
									<b>6F</b>
								</a>
							</li>
							<li id="f5">
								<a href="${pageContext.request.contextPath}/menu01_03?floor=f5">
									<b>5F</b>
								</a>
							</li>
						</ul>
						<%-- <div class="floor-pic" id="10F">
							<div>
						...
						<div class="floor-pic">
							<c:forEach var="item" items="${list}">
								<div>
									<img src="${pageContext.request.contextPath}/resources/uploadHospitalImg/${item.upload_stored}" alt=""/>
