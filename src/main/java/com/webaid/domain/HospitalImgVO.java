...
public class HospitalImgVO {
	...
	public String toString() {
		return "HospitalImgVO [no=" + no + ", floor=" + floor + ", writer=" + writer + ", regdate=" + regdate + ", cnt="
				+ cnt + ", title=" + title + ", content=" + content + ", upload_origin=" + upload_origin
				+ ", upload_stored=" + upload_stored + ", use_state=" + use_state + "]";
	}
