...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="외과 질환 센터" data-sec="유방·갑상선">
			<div class="inner">
		...
		<div class="pcode52101">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/521_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-521-01">
			</div>
		</div>
		<div class="pcode52102">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/521_img_02.png" alt="" usemap="pCode-521-02">
			</div>
		</div>
		<div class="pcode52103">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/521_img_03.png" alt="" usemap="pCode-521-03">
			</div>
		</div>
