...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		<c:forEach var="item" items="${popupListPc}">
			<div id="popup_layer_${item.no}" class="popup-wrap-box ui-draggable ui-draggable-handle" style="position: absolute; z-index: 9000; top: ${item.p_top}px; left: ${item.p_left}px;">
			<!-- 레이어 팝업 시작 -->
				<div id="pop-wrap">
					<div class="pop-inner">
						<div class="pop-container">
							<div><%-- <img alt="" src="${pageContext.request.contextPath}/resources/uploadPopup/${item.upload_stored}"> --%>${item.content}</div>
						</div>
