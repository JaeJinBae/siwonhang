	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="board-notice-list">
			<ul class="full">
				<li>
					<a href="">
						<b>  국제신문 칼럼 |  [진료실에서] ‘변실금·변비’ 약물치료 전 대장·항문 검사부터 받아야</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2019-04-24</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  KNN 닥터스 조현언, 정일권 원장님 방송출연</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2019-03-05</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  겨울철 치질, 생활습관으로 예방해보아요!</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2018-12-13</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  양산건강검진 병원, 체계적인 시원항병원에서!</b>
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2018-12-11</i>
					</a>	
				</li>
			</ul>
		</div>
