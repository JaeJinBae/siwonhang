...
<div id="wrap">
	...
	<section id="sub-container">
		...
		<!-- 서브 비주얼영역 시작  -->
		<div id="sub-visual" data-menu="커뮤니티" data-sec="진료예약">
			<div class="inner">
				...
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							...
							<li class="active"><a href="${pageContext.request.contextPath}/menu07_06">진료예약</a></li>
						</ul>
					</div>
					<div class="customer">
							...
							<table class="board-cousel-form">
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="i_phone2" id="i_phone2" maxlength="4" valid="required,phone_tel34" element-name="연락처" value="9744" class="small" autocomplete="off"> -
										<input type="text" name="i_phone3" id="i_phone3" maxlength="4" valid="required,phone_tel44" element-name="연락처" value="2045" class="small" autocomplete="off"><br><br>
