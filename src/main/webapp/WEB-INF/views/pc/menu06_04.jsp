		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							...
							<li class="active"><a href="${pageContext.request.contextPath}/menu06_04">채용검진</a></li>
						</ul>
					</div>
					<div class="customer">
				...
				<div class="sub-contents">
					<h4 class="tit">채용검진</h4><!-- 서브 콘텐츠 타이틀 -->
					...
					<div class="inner">
					<h5>채용검진</h5>
					<p class="p_h5">채용검진은 일반 기업체에서 새로 채용한 직원을 대상으로 실시하는 신체검사입니다.</p>
					
					<h5>검사항목</h5>
					<p class="p_h5">진찰, 신체계측, 혈압측정, 흉부X선 촬영, 간효소수치, 콜레스테롤, 간염항원/항체, 요당/요단백 검사</p>
					...
					<h5>검사 전에 확인하실 사항</h5>
					<p class="p_h5">제출하실 기관의 채용신검에 관한 별도의 규정이 있는지 확인하신 후 반드시 검사 전에 미리 말씀해 주셔야 합니다.</p>
