...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/menu07_03${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
...
<div id="wrap">
	...
	<section id="sub-container">
		...
		<!-- 서브 비주얼영역 시작  -->
		<div id="sub-visual" data-menu="커뮤니티" data-sec="논문발표">
			<div class="inner">
				...
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							...
							<li class="active"><a href="${pageContext.request.contextPath}/menu07_03">논문발표</a></li>
							    ...
							    <c:otherwise>
							        ...
							        <c:forEach var="item" items="${list}">
										<tr>
											<td>${num}</td>
											<td class="subject">
												<a href="${pageContext.request.contextPath}/menu07_03read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title}</a>
											</td>
