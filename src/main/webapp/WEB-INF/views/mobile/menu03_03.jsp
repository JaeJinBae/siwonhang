...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="특성화 진료" data-sec="골반저 질환(변비·변실금)">
			<div class="inner">
		...
		<div class="pcode51501">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/515_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-515-01">
			</div>
		</div>
		
		<div class="pcode51502">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/515_img_02.png" alt="" usemap="pCode-515-02">
			</div>
		</div>
