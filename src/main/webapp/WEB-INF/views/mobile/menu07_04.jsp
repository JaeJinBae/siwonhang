			...
			<ul class="full">
				<li>
					<a href="javascript:alert('접근권한이 없습니다')">
						<b>  입원환자 후기입니다.</b>
						<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-04-10</i>
					</a>	
				</li>
				<li>
					<a href="javascript:alert('접근권한이 없습니다')">
						<b>  박정민님 치료후기입니다.</b>
						<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-01-25</i>
					</a>	
				</li>
				<li>
					<a href="javascript:alert('접근권한이 없습니다')">
						<b>  마은주님 치료후기입니다.</b>
						<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-01-24</i>
					</a>	
				</li>
			</ul>
		</div>
