...
<script>
function withdrawReason(info){
	$.ajax({
		url:"${pageContext.request.contextPath}/withdrawReason",
		type:"POST",
...
$(function(){
	$("#btn-withdraw").click(function(){
		var reason = $("#reason_etc").val();
		var no = $("#session_no").val();
		var info = {"no":no, "reason":reason};
...
<div id="wrap">
	...
	<section id="sub-container">
		...
		<!-- 서브 비주얼영역 시작  -->
		<div id="sub-visual" data-menu="멤버쉽" data-sec="로그인">
			<div class="inner">
		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				...
				<div class="sub-contents">
					<h4 class="tit">회원탈퇴</h4><!-- 서브 콘텐츠 타이틀 -->
					<div id="login-form">
						<p class="cap">
							시원항병원 웹사이트 탈퇴를 원하시는 이유를 선택하여 주십시오.<br>
							탈퇴신청 후 즉시 탈퇴완료처리 되며 재가입 시 탈퇴한 아이디는 다시 사용하실 수 없습니다.<br>
							향후 더욱 좋은 사이트가 되도록 반영하겠습니다.
						</p>
						<form name="member" id="member" method="post" action="" onsubmit="return false">
							...
							<div class="leave-form">
								<textarea name="reason_etc" id="reason_etc"></textarea>
							</div>
				
							<div class="btn-group-center">
								<div class="inner">
									<button type="button" id="btn-withdraw" class="btn btn-cancel" style="background:#aaaaaa;color:#ffffff;">회원탈퇴</button>
