	...
	<div id="container">
		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<form id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/menu01_05register${pageMaker.makeSearch(pageMaker.cri.page)}">
						...
						<div class="write_box">
							<table class="write_table" cellpadding="0">
								...
								<tr class="cont">
									<td class="title">층</td>
									<td>
										<select name="floor" id="floor" class="search_sel">
								...
								<tr class="cont">
									...
									<td>
										<input type="text" class="w_form_s" name="writer" value="시원항병원">
									</td>
								</tr>
								<tr class="cont">
								...
								<tr class="cont">
									...
									<td>
										...
										<script type="text/javascript">
											CKEDITOR.replace('content',{filebrowserUploadUrl:"${pageContext.request.contextPath}/admin/imgUpload/HospitalImg",height:500});
										</script>
									</td>
								</tr>
								<tr class="cont">
