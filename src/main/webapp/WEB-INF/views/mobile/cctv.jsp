...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="inner">
			...
			<p class="p-h6">시원항 병원은 영상정보처리기기 운영·관리 방침을 통해 본 병원에서 처리하는 영상정보가 어떠한 용도와 방식으로 이용 관리되고 있는지 알려드립니다.</p>
			
			<p class="p-h6">1. 영상정보처리기기의 설치 근거 및 설치 목적<br>
			...
			<p class="p-h6">- 처리방법 : 개인영상정보의 목적 외 이용, 제3자 제공, 파기, 열람 등 요구에 관한 사항을 기록․관리하고, 보관기간 만료 시 복원이 불가능한 방법으로 영구 삭제(출력물의 경우 파쇄 또는 소각)합니다.</p>
			
			<p class="p-h6">4. 영상정보의 촬영시간, 보관기간, 보관장소 및 처리방법</p>
			<div class="scroll02" style="overflow-x: auto;">
				<table class="tbl">
					<caption>개인정보 처리의 위탁</caption>
					<colgroup>
			...
			<p class="p-h6">5. 영상정보처리기기 설치 및 관리 등의 위탁에 관한 사항<br>
			본 병원은 아래와 같이 영상정보처리기기 설치 및 관리 등을 위탁하고 있으며, 관계 법령에 따라 위탁계약 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다.<br>
			...
			<p class="p-h6">6. 개인영상정보의 운영자 영상정보 확인 방법 및 장소에 관한 사항<br>
			- 운영자 확인 방법 : 접근통제된 구역인 5층 전산실, 지하1층 방재실에서 운영자가 영상정보를 확인 할 수 있습니다.<br>
			- 확인 장소 : 5층 전산실, 지하1층 방재실<br><br>
			...
			본 병원은 개인영상정보에 관하여 열람 또는 존재확인․삭제를 요구한 경우 지체 없이 필요한 조치를 하겠습니다.<br>br&gt;
			
			8. 영상정보의 보호를 위한 기술적·관리적 및 물리적 확보조치<br>
			본 병원에서 처리하는 영상정보는 암호화 조치 등을 통하여 안전하게 관리되고 있습니다. 또한 개인영상정보보호를 위한 관리적 대책으로서 개인정보에 대한 접근 권한을 차등부여하고 있고, 개인영상정보의 위․변조 방지를 위하여 개인영상정보의 생성 일시, 열람 시 열람 목적․열람자․열람 일시 등을 기록하여 관리하고 있습니다. 이 외에도 개인영상정보의 안전한 물리적 보관을 위하여 잠금장치를 설치하고 있습니다.<br><br>
			
			9. 개인정보 처리방침 변경에 관한 사항<br>
			이 영상정보처리기기 운영․관리방침은 2018년 6월 15일에 제정되었으며 법령ㆍ정책 또는 보안기술의 변경에 따라 내용의 추가ㆍ삭제 및 수정이 있을 시에는 시행하기 최소 7일전에 본 병원에 변경사유 및 내용 등을 공지하도록 하겠습니다.<br>
			공고일자 : 2018년 6월20일 / 시행일자 : 2018년 7월 3일</p>
