...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div class="full">
				<ul>
					...
					<li class="gnb">
						...
						<ul>
							<li><a href="${pageContext.request.contextPath}/m/personal">개인정보처리방침</a></li>
							<li><a href="${pageContext.request.contextPath}/m/cctv">CCTV 운영 관리 방침</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<div class="inner">
			<h5>개인정보처리방침</h5>
			<p class="p-h6">시원항병원은(이하 "A"이라 함)은 귀하의 개인정보보호를 매우 중요시하며, 『개인정보보호법』을 준수하고 있습니다. A는 개인정보 처리방침을 통하여 귀하께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 이 개인정보 처리방침의 순서는 다음과 같습니다.</p>
			
			<p class="p-h6">1. 수집하는 개인정보의 항목 및 수집방법<br>
			A는 진단 및 치료를 위해 필요한 진료관련정보등과 건강보험급여 청구에 필요한 최소한의 개인정보만을 수집합니다.<br>
			- 수집항목 : 성명, 주민등록번호, 주소, 연락처, (관련내용 등)<br>
			- 수집방법 : 의료법 및 관련법령기준에 의해 개인정보가 포함된 진료정보 등을 접수(정보주체의 별도 동의 없이 수집 가능)
			
			
			
			2. 개인정보의 수집 및 이용목적<br>
			수집하는 개인정보는 의료법, 약사법, 건강보험법에 따른 업무(처방전의 보관 진료정보의 보관 등), 건강보험급여의 청구에만 사용하며 이용 목적이 변경될 시에는 사전 동의를 구할 것입니다.<br><br>
			
			3. 개인정보의 보유 및 이용기간 및 파기절차 및 파기방법<br>
			의료법, 약사법, 건강보험법에서 정한 보유기간 동안 개인정보를 보유하며 그 이후는 지체 없이 파기합니다.<br>
			...
			- 파기방법 : 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하고 종이에 출력된 처방전은 분쇄기로 분쇄하거나 소각하여 파기<br><br>
			
			
			4. 이용자 및 법정대리인의 권리와 그 행사방법<br>
			이용자 및 법정대리인은 개인정보와 관련하여 인터넷, 전화, 서면 등을 이용하여 약국에 연락을 하여 개인정보 열람 등의 권리를 행사할 수 있으며, 약국은 지체 없이 필요한 조치를 합니다. 약국에서 법에 따라 의무적으로 보관하고 있는 처방전, 건강보험청구 관련 자료는 이용자의 요청이 있더라도 법에서 정한 기간 동안은 변경, 삭제할 수 없습니다.<br><br>
			
			5. 개인정보의 제3자 제공<br>
			국민건강보험법에 의거 건강보험심사평가원에 요양급여비용 청구를 위해 진료기록을 제출합니다.<br>
			※ 국민건강보험법에 의해 의무적으로 제출하는 사항이므로 별도의 제공 동의 불필요<br><br>
			...
			<p class="p-h6">8. 개인정보의 안전성 확보조치<br>
			A는 이용자의 개인정보보호를 위한 기술적 대책으로서 여러 보안장치를 마련하고 있습니다. 이용자께서 제공하신 모든 정보는 방화벽 등 보안장비에 의해 안전하게 보호/관리되고 있습니다. 또한 A는 이용자의 개인정보보호를 위한 관리적 대책으로서 이용자의 개인정보에 대한 접근 및 관리에 필요한 절차를 마련하고, 이용자의 개인정보를 처리하는 인원을 최소한으로 제한하고 개인정보를 처리하는 시스템의 사용자 비밀번호를 정기적으로 갱신하여 안전하게 관리합니다.<br><br>
			
			9. 정책 변경에 따른 공지의무<br>
			이 개인정보 처리방침은 2018년 6월 15일에 제정되었으며 법령ㆍ정책 또는 보안기술의 변경에 따라 내용의 추가ㆍ삭제 및 수정이 있을 시에는 변경되는 개인정보 처리방침을 시행하기 최소 7일전 병원 홈페이지 또는 접수창구에 변경이유 및 내용 등을 공지하도록 하겠습니다.<br>
