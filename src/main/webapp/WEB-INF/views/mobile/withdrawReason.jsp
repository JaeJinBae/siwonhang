...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="fix-pad pt20 pb20">
			...
			<div id="login-form">
				<p class="cap">
					시원항병원 웹사이트 탈퇴를<br>원하시는 이유를 선택하여 주십시오.<br>
					탈퇴신청 후 즉시 탈퇴완료처리 되며<br>재가입 시 탈퇴한 아이디는<br>다시 사용하실 수 없습니다.<br>
					향후 더욱 좋은 사이트가<br>되도록 반영하겠습니다.
				</p>
			...
			<div class="btn-group-center">
				<div class="inner">
					<button type="button" id="btn-withdraw" class="btn btn-cancel">회원탈퇴</button>
