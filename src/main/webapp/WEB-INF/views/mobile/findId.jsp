...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="fix-pad pt20 pb20">
			...
			<div id="sub-visual" data-menu="멤버쉽" data-sec="아이디찾기">
				<div class="inner">
				...
				<div class="full">
					<ul>
						<li class="gnb">
							<button>멤버쉽</button>
							<ul>
								<li><a href="/m/500/?pCode=500">병원소개</a></li><li><a href="/m/507/?pCode=507">진료안내</a></li>
								<li><a href="/m/513/?pCode=513">특성화 진료</a></li><li><a href="/m/556/?pCode=556">외과 질환 센터</a></li>
								<li><a href="/m/524/?pCode=524">내과 질환 센터</a></li><li><a href="/m/529/?pCode=529">건강검진</a></li>
								...
								<tr>
									...
									<td>
										...
										<select name="m_emailcode" id="m_emailcode" title="이메일의 계정">
											<option value="" selected="">직접입력</option><option value="EM01">naver.com</option>
											<option value="EM02">daum.net</option><option value="EM03">gmail.com</option>
											<option value="EM04">yahoo.co.kr</option><option value="EM05">yahoo.com</option>
											<option value="EM06">nate.com</option><option value="EM07">paran.com</option>
											<option value="EM08">google.com</option><option value="EM09">empas.com</option>
											<option value="EM10">hotmail.com</option><option value="EM11">msn.com</option>
											<option value="EM12">korea.com</option><option value="EM13">dreamwiz.com</option>
											<option value="EM14">hanafos.com</option><option value="EM15">freechal.com</option>
											<option value="EM16">chol.com</option><option value="EM17">empal.com</option>
											<option value="EM18">lycos.com</option><option value="EM19">netian.com</option>
										</select>
									</td>
								</tr>
							</table>
