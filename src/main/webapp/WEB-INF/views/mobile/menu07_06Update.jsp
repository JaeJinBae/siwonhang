		...
		<form name="inquire" id="inquire" method="post" action="" enctype="multipart/form-data" onsubmit="return false" autocomplete="off">
			...
			<div class="inner">
				<table class="board-cousel-form">
					...
					<tr>
						<th scope="row">이름</th>
						<td><input type="text" name="i_name" id="i_name" class="default" valid="required" element-name="이름" value="김민경"></td>
					</tr>
					<tr>
						<th>제목</th>
						<td>
							<input type="text" name="i_title" id="i_title" maxlength="200" valid="required" element-name="제목" value="종합 건강검진 및 위/대장내시경">
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="i_phone2" id="i_phone2" maxlength="4" valid="required,phone_tel34" element-name="연락처" value="9744" autocomplete="off"> -
							<input type="text" name="i_phone3" id="i_phone3" maxlength="4" valid="required,phone_tel44" element-name="연락처" value="2045" autocomplete="off"><br><br>
					...
					<tr>
						<th>내용</th>
						<td>
							<textarea name="i_content" id="i_content" valid="required" element-name="내용">안녕하세요 올해 건강검진을 받아야하는데 기본 건강검진에 추가해서 위/대장내시경을 받고싶어서 문의드립니다.
							1. 위/대장내시경은 수면으로 진행하고 싶은데 가능한가요? 2. 대장내시경시 사전에 약을안먹고 가서 설사약을 직접 주입하는 방법이 있다고 들었는데 가능한가요? 3. 올해안에 2명 토요일에 검진 가능한 날이 있을까요? 4. 혹시 보호자 없이 검진받는건 불가능한가요?</textarea>
						</td>
					</tr>
					<tr>
				...
				<div class="btn-group-center">
					<div class="inner">
						...
						<button type="button" class="btn btn-cancel" onclick="inquire_it('reset', 'pCode=539&amp;i_cate=CN02')">취소</button>
					</div>
				</div>
				<!-- 게시판 버튼 끝 -->
