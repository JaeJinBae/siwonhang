			...
			<div class="inner">
				<table class="board-cousel-form">
					...
					<tbody>
						...
						<tr>
							<th scope="row">이름</th>
							<td><input type="text" name="i_name" id="i_name" class="default" valid="required" element-name="이름" value="두"></td>
						</tr>
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="i_title" id="i_title" maxlength="200" valid="required" element-name="제목" value="여의사쌤 계신가요?">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="i_phone2" id="i_phone2" maxlength="4" valid="required,phone_tel34" element-name="연락처" value="0000" autocomplete="off"> -
								<input type="text" name="i_phone3" id="i_phone3" maxlength="4" valid="required,phone_tel44" element-name="연락처" value="0000" autocomplete="off"><br><br>
						...
						<tr>
							<th>내용</th>
							<td>
								<textarea name="i_content" id="i_content" valid="required" element-name="내용">항문외과 여의사쌤 계신지 궁금하고
								곤지름 진료가능한지도 궁금합니다.
								초진 예약은 안되는지도요.</textarea>
							</td>
						</tr>
						<tr>
				...
				<div class="btn-group-center">
					<div class="inner">
							...
							<button type="button" class="btn btn-cancel" onclick="">취소</button>
					</div>
				</div>
				<!-- 게시판 버튼 끝 -->
