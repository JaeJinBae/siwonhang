			...
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							<li class="active"><a href="${pageContext.request.contextPath}/menu01_01">병원장인사말</a></li>
				...
				<div class="sub-contents">
					<h4 class="tit">병원장인사말</h4><!-- 서브 콘텐츠 타이틀 -->
					...
					<div class="pcode50001">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/500_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-500-01">
						</div>
					</div>
					<div class="pcode50002">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/500_img_02.png" alt="" usemap="pCode-500-02">
						</div>
					</div>
