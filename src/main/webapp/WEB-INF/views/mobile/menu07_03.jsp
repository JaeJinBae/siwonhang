	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="board-notice-list">
			<ul class="full">
				<li>
					<a href="">
						<b>  Does the Removal of Retained Staples Really Improve Postoperative Chronic Sequelae After Transanal Stapled Operations...</b>
						<!--i class='name'>최</i><span class='line'>|</span--><i class="date">2014-05-09</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  Fecal Continence Revisited: The Anal External Sphincter Continence Reflex [2013.11.DCR]</b>
						<!--i class='name'>최</i><span class='line'>|</span--><i class="date">2013-12-17</i>
					</a>	
				</li>
				<li>
					<a href="">
						<b>  Assessment of Female Patients With Rectal Intussusception and Prolapse: Is This a Progressive Spectrum of Disease? [D...</b>
						<!--i class='name'>최</i><span class='line'>|</span--><i class="date">2013-12-05</i>
					</a>	
				</li>	
			</ul>
		</div>
