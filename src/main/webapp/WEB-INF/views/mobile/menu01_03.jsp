	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="floor-slider">
			<div class="inner">
				...
				<ul class="floor-info">
					<li id="f10">
						<a href="${pageContext.request.contextPath}/m/menu01_03?floor=f10">
							<b>10F</b>
						</a>
					</li>
					<li id="f9">
						<a href="${pageContext.request.contextPath}/m/menu01_03?floor=f9">
							<b>9F</b>
						</a>
					</li>
					<li id="f8">
						<a href="${pageContext.request.contextPath}/m/menu01_03?floor=f8">
							<b>8F</b>
						</a>
					</li>
					<li id="f7">
						<a href="${pageContext.request.contextPath}/m/menu01_03?floor=f7">
							<b>7F</b>
						</a>
					</li>
					<li id="f6">
						<a href="${pageContext.request.contextPath}/m/menu01_03?floor=f6">
							<b>6F</b>
						</a>
					</li>
					<li id="f5">
						<a href="${pageContext.request.contextPath}/m/menu01_03?floor=f5">
							<b>5F</b>
						</a>
					</li>
				</ul>
