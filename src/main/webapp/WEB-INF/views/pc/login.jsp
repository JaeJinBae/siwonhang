		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				...
				<div class="sub-contents">
					<h4 class="tit">로그인</h4><!-- 서브 콘텐츠 타이틀 -->
					...
					<div id="login-form">
						<ul class="login-inner">
							...
							<li class="member">
								<p>아이디나 비밀번호를 분실하셨나요?<a href="${pageContext.request.contextPath}/findId">아이디/비밀번호 찾기</a></p>
								<p>아직 회원이 아니신가요?<a href="${pageContext.request.contextPath}/join" class="btn-join">회원가입</a></p>
							</li>
						</ul>
					</div>
					<!-- 로그인 폼 끝 -->
