...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/menu07_06${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
							        ...
							        <c:forEach var="item" items="${list}">
										<tr>
											...
											<td class="subject" data-state="비공개">
												<a href="${pageContext.request.contextPath}/menu07_06pwChk${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title} <img src="${pageContext.request.contextPath}/resources/img/common/20180807_FD7F4F2AEC4341BF.png" alt="비공개" class="secret"></a>
											</td>
