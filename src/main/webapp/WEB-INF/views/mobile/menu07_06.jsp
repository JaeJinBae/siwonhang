	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="board-counsel-list">
			<ul class="full">
				<li>
					<a href="">
						<b><!--<i class='board-bullet' data-cate='NEW'>NEW</i>-->건강검진 및 위 내시경(일반) 검사 예약</b>
						<i class="name">이수주</i><span class="line">|</span><i class="date">2019-10-31</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state ready">답변대기</i></div>
				</li>
				<li>
					<a href="">
						<b><!---->종합 건강검진 및 위/대장내시경</b>
						<i class="name">김민경</i><span class="line">|</span><i class="date">2019-10-07</i><span class="line">|</span><i class="date">비공개</i>
					</a>
				...
				<li>
					<a href="">
						<b><!---->위/대장 내시경</b>
						<i class="name">김현우</i><span class="line">|</span><i class="date">2019-09-14</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state com">답변완료</i></div>
				</li>
				<li>
					<a href="">
						<b><!---->외치핵 진료&amp;수술</b>
						<i class="name">박은지</i><span class="line">|</span><i class="date">2019-07-30</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state com">답변완료</i></div>
				</li>
				<li>
					<a href="">
						<b><!---->대장내시경</b>
						<i class="name">...</i><span class="line">|</span><i class="date">2019-06-25</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state com">답변완료</i></div>
				</li>
			</ul>
