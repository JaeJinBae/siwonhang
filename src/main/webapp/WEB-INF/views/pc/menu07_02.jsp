...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/menu07_02${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
							    ...
							    <c:otherwise>
							        ...
							        <c:forEach var="item" items="${list}">
										<tr>
											<td>${num}</td>
											<td class="subject">
												<a href="${pageContext.request.contextPath}/menu07_02read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title}</a>
											</td>
