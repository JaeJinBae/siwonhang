...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="pcode52401">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/524_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-524-01">
			</div>
		</div>
		<div class="pcode52402">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/524_img_02.png" alt="" usemap="pCode-524-02">
			</div>
		</div>
		<div class="pcode52403">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/524_img_03.png" alt="" usemap="pCode-524-03">
			</div>
		</div>
