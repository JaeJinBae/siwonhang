	...
	<div class="inner">
		...
		<ul class="special-diagnosis">
			<li class="bg01">
				...
				<a href="${pageContext.request.contextPath}/" class="more">자세히 보기</a>
			</li>
			<li class="bg02">
...
<section class="health-center">
	<ul class="inner">
		...
		<li>
			<a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/resources/img/main/health_center01.png" alt=""></a>
			<a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/resources/img/main/health_center02.png" alt=""></a>
			<a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/resources/img/main/health_center03.png" alt=""></a>
			<a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/resources/img/main/health_center04.png" alt=""></a>
		</li>
	</ul>
</section>
<!-- 중앙 배너 끝 -->
...
<section class="information">
	<div class="inner">
		...
		<ul class="medical-info">
			...
			<li class="location">
				...
				<a class="more" href="${pageContext.request.contextPath}/">자세히 보기</a>
			</li>
	...
	<li><a href="${pageContext.request.contextPath}/">시원항병원 홈페이지를 오픈하였습니다.</a></li>
				...
				<a href="${pageContext.request.contextPath}/" class="more">MORE +</a>
			</li>
			<li class="newsletter">
				<!--
				<a href="/html/?pCode=535">
					<i class="thumb">
						<img src="/assets/img/main/floor.png" alt=""/>
						<i class="more">언론보도 +</i>
					</i>
					<span class="cap">조현언 원장, 2018 SERAF 동남권 대장항문포럼 발표 조현언 원장 조현언 원장 조현언 원장</span>
				</a>
				-->
...
<!-- 시원항 병원 진료안내 끝 -->
				...
				</section></div><!-- #contents .inner .sub-contents 닫기 -->
			<!-- #contents .inner 닫기 -->
		<!-- #contents 닫기 -->
	...
	<footer id="footer">
		<div class="inner">
			<ul class="footer-info">
				...
				<p>
					<span>병원명 : 시원항병원</span>
					<span>대표 : 조현언, 정일권</span>
					<span>TEL : 051-331-7275</span>
					<span>FAX : 051-332-0975</span>
					<span>사업자등록번호 : 553-82-00228</span>
				</p>
				<p>
...
<!-- NAVER SCRIPT START 10/19 -->
<script type="text/javascript" src="https://wcs.naver.net/wcslog.js"></script>
<script type="text/javascript">
if (!wcs_add) var wcs_add={};
wcs_add["wa"] = "s_1ff8eb33f2fd";
if (!_nasa) var _nasa={};
wcs.inflow();
wcs_do(_nasa);
</script>
<!-- NAVER SCRIPT END 10/19 -->
<!-- AceCounter Log Gathering Script V.7.5.2017020801 -->
	<script language="javascript">
		var _AceGID=(function(){var Inf=['dgc5.acecounter.com','8080','AP2T42497517824','CW','0','NaPm,Ncisy','ALL','0']; var _CI=(!_AceGID)?[]:_AceGID.val;var _N=0;var _T=new Image(0,0);if(_CI.join('.').indexOf(Inf[3])<0){ _T.src =( location.protocol=="https:"?"https://"+Inf[0]:"http://"+Inf[0]+":"+Inf[1]) +'/?cookie'; _CI.push(Inf);  _N=_CI.length; } return {o: _N,val:_CI}; })();
		var _AceCounter=(function(){var G=_AceGID;var _sc=document.createElement('script');var _sm=document.getElementsByTagName('script')[0];if(G.o!=0){var _A=G.val[G.o-1];var _G=(_A[0]).substr(0,_A[0].indexOf('.'));var _C=(_A[7]!='0')?(_A[2]):_A[3];var _U=(_A[5]).replace(/\,/g,'_');_sc.src=(location.protocol.indexOf('http')==0?location.protocol:'http:')+'//cr.acecounter.com/Web/AceCounter_'+_C+'.js?gc='+_A[2]+'&py='+_A[4]+'&gd='+_G+'&gp='+_A[1]+'&up='+_U+'&rd='+(new Date().getTime());_sm.parentNode.insertBefore(_sc,_sm);return _sc.src;}})();
	</script>
	<noscript><img src='http://dgc5.acecounter.com:8080/?uid=AP2T42497517824&je=n&' border='0' width='0' height='0' alt=''></noscript>
