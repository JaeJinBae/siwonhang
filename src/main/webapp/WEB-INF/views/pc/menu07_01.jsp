...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/menu07_01${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
			...
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							<li class="active"><a href="${pageContext.request.contextPath}/menu07_01">공지사항</a></li>
								...
								<c:if test="${fn:length(topList) != 0}">
									<c:forEach var="item" items="${topList}">
										<tr class="noticeTop">
											...
											<td class="subject">
												<a href="${pageContext.request.contextPath}/menu07_01read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title}</a>
											</td>
