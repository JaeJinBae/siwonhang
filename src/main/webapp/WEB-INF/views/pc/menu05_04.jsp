				...
				<ul>
					...
					<li class="gnb">
						...
						<ul>
							...
							<li><a href="${pageContext.request.contextPath}/menu05_03">호흡기 질환</a></li>
							<li><a href="${pageContext.request.contextPath}/menu05_04">내분비 질환</a></li>
							<li><a href="${pageContext.request.contextPath}/menu05_05">위·대장 내시경</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							...
							<li class="active"><a href="${pageContext.request.contextPath}/menu05_04">내분비 질환</a></li>
				...
				<div class="sub-contents">
					<h4 class="tit">내분비 질환</h4><!-- 서브 콘텐츠 타이틀 -->
					...
					-->
					<div class="pcode52701">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/527_img_01.png" alt="성형외과 &amp; 피부과 협진으로 최소 시술 최대 효과" usemap="pCode-527-01">
						</div>
					</div>
					<div class="pcode52702">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/527_img_02.png" alt="" usemap="pCode-527-02">
						</div>
					</div>
					<div class="pcode52703">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/527_img_03.png" alt="" usemap="pCode-527-03">
						</div>
					</div>
					<div class="pcode52704">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/527_img_04.png" alt="" usemap="pCode-527-04">
						</div>
					</div>
					<div class="pcode52705">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/527_img_05.png" alt="" usemap="pCode-527-05">
						</div>
					</div>
				</div>
