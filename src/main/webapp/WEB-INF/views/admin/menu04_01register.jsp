						...
						<form id="form1" method="post"action="${pageContext.request.contextPath}/admin/menu04_01register${pageMaker.makeSearch(pageMaker.cri.page)}">
							...
							<table class="write_table" cellpadding="0">
								...
								<tr class="cont">
									...
									<td><input type="radio" name="t_mode" id="t_mode1" value="W" checked="checked"><label for="t_mode1"><i></i>웹</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="t_mode" id="t_mode2" value="M"> <label for="t_mode2"><i></i>모바일</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								</tr>
								<tr class="cont">
								...
								<tr class="cont">
									...
									<td>
										<input type="text" class="w_form_s" id="p_sun" name="p_sun" value="" element-name="출력순서">
									</td>
								</tr>
								<tr class="cont">
									<td class="title">위치</td>
									<td>
										X : <input type="text" class="w_form_s" name="p_left" value="" valid="none,number" element-name="위치">
										Y : <input type="text" class="w_form_s" name="p_top" value="" valid="none,number" element-name="위치">
								...
								<tr class="cont">
									...
									<td><input type="text" class="w_form_l" name="p_link" value="" placeholder="ex) http://www.xxx.co.kr/html/?pCode=417"></td>
								</tr>
								<tr class="cont">
									<td class="title">제목</td>
									<td><input type="text" class="w_form_l" name="p_title" value="" valid="required" element-name="제목"></td>
								</tr>
								<tr class="cont">
