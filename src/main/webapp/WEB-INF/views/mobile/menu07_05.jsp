		...
		<div class="board-counsel-list">
			<ul class="full">
				...
				<li>
					<a href="">
						<b><!---->화농성 한선염?</b>
						<i class="name">김익명</i><span class="line">|</span><i class="date">2019-10-25</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state com">답변완료</i></div>
				</li>
				<li>
					<a href="">
						<b><!---->항문곤지름</b>
						<i class="name">원항</i><span class="line">|</span><i class="date">2019-10-07</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state com">답변완료</i></div>
				</li>
				<li>
					<a href="">
						<b><!---->직징 내 곤지름 관련</b>
						<i class="name">충전</i><span class="line">|</span><i class="date">2019-09-21</i><span class="line">|</span><i class="date">비공개</i>
					</a>
					<div class="answer"><i class="state com">답변완료</i></div>
				</li>
			</ul>
