...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="내과 질환 센터" data-sec="소화기 질환">
			<div class="inner">
			...
			<div class="full">
				<ul>
					...
					<li class="gnb">
						...
						<ul>
							<li><a href="${pageContext.request.contextPath}/m/menu05_01">소화기 질환</a></li>
							<li><a href="${pageContext.request.contextPath}/m/menu05_02">순환기 질환</a></li>
							<li><a href="${pageContext.request.contextPath}/m/menu05_03">호흡기 질환</a></li>
							<li><a href="${pageContext.request.contextPath}/m/menu05_04">내분비 질환</a></li>
							<li><a href="${pageContext.request.contextPath}/m/menu05_05">위·대장 내시경</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<div class="pcode52701">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/527_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-527-01">
			</div>
		</div>
		<div class="pcode52702">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/527_img_02.png" alt="" usemap="pCode-527-02">
			</div>
		</div>
