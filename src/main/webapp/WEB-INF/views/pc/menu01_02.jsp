	...
	<section id="sub-container">
		...
		<div id="breadcrumb">
			<div class="inner">
				<ul>
					...
					<li class="gnb">
						<button class="">차별성</button>
						<ul style="display: none;">
							<li><a href="${pageContext.request.contextPath}/menu01_01">병원장인사말</a></li>
							<li><a href="${pageContext.request.contextPath}/menu01_02">차별성</a></li>
							<li><a href="${pageContext.request.contextPath}/menu01_03">층별안내</a></li>
		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						<h3 class="tit" data-menu="병원소개">병원소개</h3>
						<ul>
							<li class=""><a href="${pageContext.request.contextPath}/menu01_01">병원장인사말</a></li>
							<li class="active"><a href="${pageContext.request.contextPath}/menu01_02">차별성</a></li>
							<li class=""><a href="${pageContext.request.contextPath}/menu01_03">층별안내</a></li>
							<li class=""><a href="${pageContext.request.contextPath}/menu01_04">오시는 길</a></li>
						</ul>
					</div>
					<div class="customer">
				...
				<div class="sub-contents">
					<h4 class="tit">차별성</h4><!-- 서브 콘텐츠 타이틀 -->
					...
					<div class="pcode50201">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-502-01">
						</div>
					</div>
					<div class="pcode50202">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_02.png" alt="" usemap="pCode-502-02">
						</div>
					</div>
					<div class="pcode50203">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_03.png" alt="" usemap="pCode-502-03">
						</div>
					</div>
					<div class="pcode50204">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_04.png" alt="" usemap="pCode-502-04">
						</div>
					</div>
					<div class="pcode50205">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_05.png" alt="" usemap="pCode-502-05">
						</div>
					</div>
					<div class="pcode50206">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_06.png" alt="" usemap="pCode-502-06">
						</div>
					</div>
					<div class="pcode50207">
						<div class="full">
							<img src="${pageContext.request.contextPath}/resources/img/contents/502_img_07.png" alt="" usemap="pCode-502-07">
						</div>
					</div>
