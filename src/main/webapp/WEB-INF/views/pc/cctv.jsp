...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<!-- 서브 비주얼영역 시작  -->
		<div id="sub-visual" data-menu="멤버십" data-sec="CCTV 운영 관리 방침">
			<div class="inner">
			...
			<div class="inner">
				<div class="pnb-wrap">
					<div class="pnb">
						...
						<ul>
							<li class="active"><a href="${pageContext.request.contextPath}/cctv">CCTV 운영 관리 방침</a></li>
							<li class=""><a href="${pageContext.request.contextPath}/personal">개인정보처리방침</a></li>
						</ul>
					</div>
					<div class="customer">
				...
				<div class="sub-contents">
					<h4 class="tit">CCTV 운영 관리 방침</h4><!-- 서브 콘텐츠 타이틀 -->
					...
					<div class="inner">
					<h5>영상정보처리기기(CCTV) 운영․관리 방침</h5>
					<p class="p_h5">시원항 병원은 영상정보처리기기 운영·관리 방침을 통해 본 병원에서 처리하는 영상정보가 어떠한 용도와 방식으로 이용 관리되고 있는지 알려드립니다.</p>
					
					
					<ol class="list_num_h5">
						<h6> 1. 영상정보처리기기의 설치 근거 및 설치 목적	</h6>
						<p class="p_h5">
						본 병원은「개인정보 보호법」제25조 제1항에 따라 다음과 같은 목적으로 영상정보처리기기를 설치·운영 합니다.<br>
							 - 시설안전 및 화재 예방<br>
							 - 고객의 안전을 위한 범죄 예방<br>
						 </p><br>
						...
						<table class="tbl tac">
							...
							<thead>
							  ...
							  <tr>
								<td>44대</td>
								<td>건물1층 로비, 주차장 진출입로, 엘리베이터, 5층~10층, 옥상</td>
						...
						<ul>
						<p class="p_h5">- 처리방법 : 개인영상정보의 목적 외 이용, 제3자 제공, 파기, 열람 등 요구에 관한 사항을 기록․관리하고, 보관기간 만료 시 복원이 불가능한 방법으로 영구 삭제(출력물의 경우 파쇄 또는 소각)합니다.</p>
						<ul><br>
					
					
						<h6> 4. 영상정보의 촬영시간, 보관기간, 보관장소 및 처리방법 </h6>
						<table class="tbl tac">
							...
							<h6>  5. 영상정보처리기기 설치 및 관리 등의 위탁에 관한 사항 </h6>
					
							
							<p class="p_h5">본 병원은 아래와 같이 영상정보처리기기 설치 및 관리 등을 위탁하고 있으며, 관계 법령에 따라 위탁계약 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다.
							
					
					
						</p><table class="tbl tac">
							...
							<thead>
							  ...
							  <tr>
								...
								<h6>  6. 개인영상정보의 운영자 영상정보 확인 방법 및 장소에 관한 사항 </h6>
					
							<p class="p_h5"> - 운영자 확인 방법 : 접근통제된 구역인 5층 전산실, 지하1층 방재실에서 운영자가 영상정보를 확인 할 수 있습니다.<br>
							  - 확인 장소 : 5층 전산실, 지하1층 방재실<br>
					         </p>
					
					
							 	<h6>   7. 정보주체의 영상정보 열람 등 요구에 대한 조치</h6>
					
							<p class="p_h5">귀하는 개인영상정보에 관하여 열람 또는 존재확인․삭제를 원하는 경우 언제든지 영상정보처리기기 운영자에게 요구하실 수 있습니다.<br> 
							...
							본 병원은 개인영상정보에 관하여 열람 또는 존재확인․삭제를 요구한 경우 지체 없이 필요한 조치를 하겠습니다.
							 	...
							 	<h6>   8. 영상정보의 보호를 위한 기술적·관리적 및 물리적 확보조치</h6>
					
							<p class="p_h5">본 병원에서 처리하는 영상정보는 암호화 조치 등을 통하여 안전하게 관리되고 있습니다. 또한 개인영상정보보호를 위한 관리적 대책으로서 개인정보에 대한 접근 권한을 차등부여하고 있고, 
								개인영상정보의 위․변조 방지를 위하여 개인영상정보의 생성 일시, 열람 시 열람 목적․열람자․열람 일시 등을 기록하여 관리하고 있습니다. 이 외에도 개인영상정보의 안전한 물리적 보관을 위하여 잠금장치를 설치하고 있습니다.
					          </p>
					
					
						<h6>    9. 개인정보 처리방침 변경에 관한 사항</h6>
					
							<p class="p_h5"> 이 영상정보처리기기 운영․관리방침은 2018년 6월 15일에 제정되었으며 법령ㆍ정책 또는 보안기술의 변경에 따라 내용의 추가ㆍ삭제 및 수정이 있을 시에는 시행하기 최소 7일전에 본 병원에 변경사유 및 내용 등을 공지하도록 하겠습니다.<br>
						공고일자 : 2018년 6월20일  / 시행일자 : 2018년 7월 3일
					         </p>
		
						</ul></ul></ol></div><!-- #contents .inner .sub-contents 닫기 -->
