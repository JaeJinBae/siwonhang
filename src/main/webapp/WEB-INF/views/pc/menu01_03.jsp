			...
			<div class="inner">
				...
				<div class="sub-contents">
					...
					<div class="floor-slider">
						...
						<div class="floor-pic" id="f9">
							<c:forEach var="item" items="${nine}">
								<div>
									<img src="${pageContext.request.contextPath}/resources/uploadHospitalImg/${item.upload_stored}" alt=""/>
									<span class="tit">${item.title}</span>
								</div>
						...
						<div class="floor-pic" id="f8">
							<c:forEach var="item" items="${eight}">
								<div>
									<img src="${pageContext.request.contextPath}/resources/uploadHospitalImg/${item.upload_stored}" alt=""/>
									<span class="tit">${item.title}</span>
								</div>
						...
						<div class="floor-pic" id="f7">
							<c:forEach var="item" items="${seven}">
								<div>
									<img src="${pageContext.request.contextPath}/resources/uploadHospitalImg/${item.upload_stored}" alt=""/>
									<span class="tit">${item.title}</span>
								</div>
						...
						<div class="floor-pic" id="f6">
							<c:forEach var="item" items="${six}">
								<div>
									<img src="${pageContext.request.contextPath}/resources/uploadHospitalImg/${item.upload_stored}" alt=""/>
									<span class="tit">${item.title}</span>
								</div>
						...
						<div class="floor-pic" id="f5">
							<c:forEach var="item" items="${five}">
								<div>
									<img src="${pageContext.request.contextPath}/resources/uploadHospitalImg/${item.upload_stored}" alt=""/>
									<span class="tit">${item.title}</span>
								</div>
