...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/m/menu07_06${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
});
</script>
</head>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
				    ...
				    <c:otherwise>
				        <c:forEach var="item" items="${list}">
							<li>
								...
								<a href="${pageContext.request.contextPath}/m/menu07_06pwChk${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">
									<b><!---->${item.title}</b>
		...
		<div class="btn-group">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/m/menu07_06write" class="btn btn-list">글쓰기</a>
			</div>
		</div>
		<!-- 게시판 버튼 끝 -->
