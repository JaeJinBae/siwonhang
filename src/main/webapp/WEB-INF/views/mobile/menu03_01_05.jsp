...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="inner active">
			...
			<h5>직장류</h5>
			<p class="pcode56501 p-h6">
				<img src="/assets/img/contents/565_img_01.jpg" alt="">
			...
			<h6>외과적 치료</h6>
			<p class="p-h6">
				만약 내과적 치료에도 성공하지 못하고 계속적으로 증상이 남아있을 경우에는 수술적 치료가 필요로 하게 됩니다. 직장류를 수술하기 위해 여러가지 방법이 있습니다. 직장류 수술은 항문을 통해서 하거나 질 쪽을 통해서 하거나, 항문과 질 간벽 사이로 수술을 시행할 수 있고 복부 수술을 통해서도 할 수 있습니다.<br>
