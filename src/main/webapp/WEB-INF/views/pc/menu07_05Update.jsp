			...
			<div class="inner">
				...
				<div class="sub-contents">
					...
					<form name="inquire" id="inquire" method="post" action="" enctype="multipart/form-data" onsubmit="return false" autocomplete="off">
						...
						<input type="hidden" name="i_cate" value="CN01">
						<div class="inner">
							<table class="board-cousel-form">
								...
								<tr>
									<th scope="row">이름</th>
									<td><input type="text" name="i_name" id="i_name" class="default" valid="required" element-name="이름" value="원항"></td>
								</tr>
								<tr>
									<th>제목</th>
									<td>
										<input type="text" name="i_title" id="i_title" maxlength="200" valid="required" element-name="제목" value="항문곤지름">
									</td>
								</tr>
								<tr>
									<th>연락처</th>
									<td>
										...
										<input type="text" name="i_phone2" id="i_phone2" maxlength="4" valid="required,phone_tel34" element-name="연락처" value="3839" class="small" autocomplete="off"> -
										<input type="text" name="i_phone3" id="i_phone3" maxlength="4" valid="required,phone_tel44" element-name="연락처" value="0777" class="small" autocomplete="off"><br><br>
								...
								<tr>
									<th>내용</th>
									<td>
										<textarea name="i_content" id="i_content" valid="required" element-name="내용">남자항문주위랑항문곤지름 문의입니다 당일수술가능한지 알고싶습니다 수면마취후 수술가능핫지알고싶습니다</textarea>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="form-file">
											<div>
												<input type="file" name="upload[]" style="width: 450px; position: absolute; clip: rect(0px, 0px, 0px, 0px); display: none;" id="jfilestyle-0" tabindex="-1"><div class="jfilestyle jfilestyle-corner  jfilestyle-theme-default"><div name="filedrag" style="position: absolute; width: 100%; height: 35px; z-index: -1;"></div><input type="text" style="width:150px" placeholder="" disabled=""> <span class="focus-jfilestyle" tabindex="0"><label for="jfilestyle-0"><span>파일첨부</span></label></span></div><br>
											</div>
										</div>
										<script>
								...
								<div class="inner">
									<ul>
										...
										<li class="fr">
											...
											<button type="button" class="btn btn-cancel" onclick="inquire_it('reset', 'pCode=538&amp;page=1')">취소</button>
										</li>
									</ul>
