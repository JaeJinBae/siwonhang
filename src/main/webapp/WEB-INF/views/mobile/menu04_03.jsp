...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="외과 질환 센터" data-sec="하지정맥류">
			<div class="inner">
		...
		<div class="pcode52201">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/522_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-522-01">
			</div>
		</div>
		<div class="pcode52202">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/522_img_02.png" alt="" usemap="pCode-522-02">
			</div>
		</div>
		<div class="pcode52203">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/522_img_03.png" alt="" usemap="pCode-522-03">
			</div>
		</div>
		<div class="pcode52204">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/522_img_04.png" alt="" usemap="pCode-522-04">
			</div>
		</div>
		<div class="pcode52205">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/522_img_05.png" alt="" usemap="pCode-522-05">
			</div>
		</div>
