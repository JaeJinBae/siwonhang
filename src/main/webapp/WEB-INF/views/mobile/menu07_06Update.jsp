...
function deleteUploadImg(no, type){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/m/menu07_06uploadImgDelete",
		type:"post",
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<form name="inquire" id="form1" method="post" action="${pageContext.request.contextPath}/m/menu07_06update${pageMaker.makeSearch(pageMaker.cri.page)}" enctype="multipart/form-data">
