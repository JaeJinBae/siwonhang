...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="board-notice-view">
			<ul class="full">
				<li class="subject">	
					<div class="title"> 시원항병원 5월 휴진 안내</div>
					<p class="info">
						<!--i class='name'>시</i><span class='line'>|</span--><i class="date">2019-05-03</i><span class="line">|</span><i class="hit">조회수		281</i>
					</p>
				</li>
				<li class="con">
		...
		<div class="prev-next-list">
			<ul class="full">
				...
				<li>
					<span>다음글</span><a href=""><b>[공지]</b> 시원항병원에 1월부터 새로운 의료진이 함께합니다.</a>
				</li>
			</ul>
		</div>
