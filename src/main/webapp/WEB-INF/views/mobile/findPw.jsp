...
$(function(){
	$("#btnSubmit").click(function(){
		...
		var info = {"id":id, "name":name, "email":email};
		findPw(info);
	});
		...
		<div class="fix-pad pt20 pb20">
			...
			<div id="find-account">
				...
				<ul class="find-account-inner">
					<li>
						<form name="f1" id="f1" method="post" action="${pageContext.request.contextPath}/m/findPwEnd">
							...
							<button type="button" id="btnSubmit" onclick="">비밀번호 찾기</button>
						</form>
					</li>
				</ul>
			</div>
