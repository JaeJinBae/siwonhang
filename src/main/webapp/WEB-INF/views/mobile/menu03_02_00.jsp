...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="siwonhanh-tab">
			<ul>
				<li>
					<a href="${pageContext.request.contextPath}/m/menu03_02_01" title=""><span>맹장염수술</span></a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/m/menu03_02_02" title=""><span>탈장수술</span></a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/m/menu03_02_03" title=""><span>담낭절제술</span></a>
				</li>
			</ul>
		</div>
		<!-- 대장 항문외과 탭메뉴 끝 -->
		...
		<div class="pcode51403">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/514_img_02.png" alt="" usemap="pCode-514-03">
			</div>
		</div>
		<div class="pcode51403">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/514_img_03.png" alt="" usemap="pCode-514-03">
			</div>
		</div>
		<div class="pcode51404">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/514_img_04.png" alt="" usemap="pCode-514-04">
			</div>
		</div>
		<div class="pcode51405">
			<div class="full">
