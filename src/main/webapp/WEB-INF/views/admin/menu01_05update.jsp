	...
	<div id="container">
		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<form id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/menu01_05update${pageMaker.makeSearch(pageMaker.cri.page)}">
						...
						<div class="write_box">
							<table class="write_table" cellpadding="0">
								...
								<tr class="cont">
									<td class="title">층</td>
									<td>
										<input type="hidden" id="floor_val" value="${item.floor}">
