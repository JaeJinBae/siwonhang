...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/menu07_05${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				...
				<div class="sub-contents">
							        ...
							        <c:forEach var="item" items="${list}">
										<tr>
											...
											<td class="subject" data-state="비공개">
												<a href="${pageContext.request.contextPath}/menu07_05pwChk${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title} <img src="${pageContext.request.contextPath}/resources/img/common/20180807_FD7F4F2AEC4341BF.png" alt="비공개" class="secret"></a>
											</td>
					...
					<div class="btn-group">
						<div class="inner">
							<a href="${pageContext.request.contextPath}/menu07_05write" class="btn btn-submit">글쓰기</a>
						</div>
					</div>
					<!-- 게시판 버튼 끝 -->
