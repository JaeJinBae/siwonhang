...
function deleteUploadImg(no, type){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/menu07_05uploadImgDelete",
		type:"post",
		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				...
				<div class="sub-contents">
					...
					<!-- privacy -->
					<form name="inquire" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/menu07_05update${pageMaker.makeSearch(pageMaker.cri.page)}">
						...
						기간 동안 보존합니다. - 보존 이유 : 회원님의 동의를 통한 정보 유지 - 보존 기간 : 회원정보 삭제 요청 시까지</textarea>
								<p>
									<input type="checkbox" id="agree" valid="required" element-name="개인정보취급방침" name="agree" value="Y" checked="checked">
								...
								<div class="inner">
									<ul>
										...
										<li class="fr">
											...
											<button type="button" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/menu07_05'">취소</button>
										</li>
									</ul>
								</div>
							</div>
