		...
		<div id="contents" style="height: auto;">
			<div class="inner">
				...
				<div class="sub-contents">
						...
						<ul class="inner">
							<li>
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="${pageContext.request.contextPath}/menu07_02read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
									</c:otherwise>
								</c:choose>
							</li>
							<li>
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="${pageContext.request.contextPath}/menu07_02read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
									</c:otherwise>
								</c:choose>
							</li>
						</ul>
					...
					<div class="btn-group">
						<div class="inner">
							<a href="${pageContext.request.contextPath}/menu07_02${pageMaker.makeSearch(pageMaker.cri.page)}" class="btn btn-list">목록으로</a>
						</div>
					</div>
					<!-- 게시판 버튼 끝 -->
