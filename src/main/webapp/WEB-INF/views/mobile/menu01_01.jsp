			...
			<div class="full">
				<ul>
					<li class="gnb">
						<button>병원소개</button>
						<ul>
							<li><a href="${pageContext.request.contextPath}/m/">병원소개</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">진료안내</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">특성화 진료</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">외과 질환 센터</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">내과 질환 센터</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">건강검진</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">커뮤니티</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">멤버십</a></li>
						</ul>
					</li>
					<li class="gnb">
						<button>병원장인사말</button>
						<ul>
							<li><a href="${pageContext.request.contextPath}/m/">병원장인사말</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">차별성</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">층별안내</a></li>
							<li><a href="${pageContext.request.contextPath}/m/">오시는 길</a></li>
						</ul>
					</li>
				</ul>
			</div>
