...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="진료안내" data-sec="외래 진료안내">
			<div class="inner">
		...
		<div class="pcode50801">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/m/contents/508_img_01.png" alt="분야별 외과 전문의가 진료하는" usemap="pCode-508-01">
			</div>
		</div>
