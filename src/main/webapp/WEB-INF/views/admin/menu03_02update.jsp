...
$(function(){
	...
	$("#delBtn").click(function(){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/admin/menu03_02delete/"+no,
			type:"get",
			dataType:"text",
			async:false,
			success:function(json){
				location.href="${pageContext.request.contextPath}/admin/menu03_02";
			} 
		});
	});
});
	...
	<div id="container">
		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<form name="inquire" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/menu03_02update${pageMaker.makeSearch(pageMaker.cri.page)}">
					...
					<div class="write_area">
						...
						<div class="btn_area">
							...
							<p class="btn_right">
								...
								<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu03_02'">취소</button>
							</p>
						</div>
					</div>
				</form>
